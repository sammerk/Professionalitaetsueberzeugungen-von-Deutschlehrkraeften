...
Die $N_1 =$ `{r} n1` Deutschlehrkräfte aus Stichprobe 1 gaben im Durschnitt `{r} round(anz_oa_n1, 2)` frei formulierte Antworten auf die Frage was ihrer Meinung nach Professionalität in der Deutsch-Fachdidaktik (Sprache) ausmacht. Alle Antworten sind im [Online-Supplement](https://openmanuscript008.netlify.app/_manuscript/_notebooks/word_embeddings-preview.html#tbl-Antwort-Item-Ähnlichkeit) vollständig abgebildet
